...
import com.disertatie.mylibrary.web.AuthorController;
...
privileged aspect AuthorController_Roo_Controller {
    ...
    public String AuthorController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String AuthorController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Author.findAuthor(id));
        return "authors/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String AuthorController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
