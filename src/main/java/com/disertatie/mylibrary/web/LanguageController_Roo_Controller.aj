...
import com.disertatie.mylibrary.web.LanguageController;
...
privileged aspect LanguageController_Roo_Controller {
    ...
    public String LanguageController.show(@PathVariable("id") Integer id, Model uiModel) {
        uiModel.addAttribute("language", Language.findLanguage(id));
    ...
    public String LanguageController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Language.findLanguage(id));
        return "languages/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String LanguageController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Language language = Language.findLanguage(id);
        language.remove();
        uiModel.asMap().clear();
