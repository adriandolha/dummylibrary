...
import com.disertatie.mylibrary.web.CategoryController;
...
privileged aspect CategoryController_Roo_Controller {
    ...
    public String CategoryController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String CategoryController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Category.findCategory(id));
        return "categorys/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String CategoryController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
