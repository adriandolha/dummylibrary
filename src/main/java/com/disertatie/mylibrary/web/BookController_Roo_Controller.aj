...
import com.disertatie.mylibrary.web.BookController;
...
privileged aspect BookController_Roo_Controller {
    ...
    public String BookController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String BookController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Book.findBook(id));
        return "books/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String BookController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void BookController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("book_dateadded_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
    }
